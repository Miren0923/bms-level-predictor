...
def argument_parser_helper():
	...
	parser.add_argument('-p', '--pattern', help='pattern name', type=str)
...
data = parser.patternParser(os.path.join(pattern_dir, args.pattern), period)
label_data = int(args.pattern.split('|')[0])
